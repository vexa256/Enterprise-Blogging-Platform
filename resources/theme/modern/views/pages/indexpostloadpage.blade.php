@foreach($lastFeatures as $k => $item)
                ...
                <div class="content-timeline__detail">
                    <div class="content-timeline__detail__container">
                        ...
                        <div class="content-timeline__detail--bottom">
                            ...
                            <div class="content-timeline__detail__date share_counts " >{{ $DB_USER_LANG=="en" ? $item->published_at->format('j M, h:i A') : $item->published_at->diffForHumans() }}</div>
    ...
    @if(count($lastvideoscol1)>0 and $k==4  and get_buzzy_config('p_buzzyvideos') == 'on')
