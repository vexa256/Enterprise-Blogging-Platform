...
<div class="drawer">
    <div class="drawer__header clearfix">
        <div class="drawer__header__logo"><a href="/"><img src="{{ asset('assets/images/logo.png') }}" alt=""></a></div>
    ...
    <ul class="drawer__menu">
        ...
        @foreach(\App\Categories::byMain()->byActive()->orderBy('order')->limit(9)->get() as $categorys)
