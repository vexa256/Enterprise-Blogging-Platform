<div class="external-sign-in">
    ...
    <a href="http://pinterest.com/pin/create/link/?url={{ url('/') }}&media={{ url(makepreview($entry->image, null, 'entries')) }}&description={{ isset($entry->title) ? $entry->title : $post->title }}" class="Pinterest popup-action mini"></a>
