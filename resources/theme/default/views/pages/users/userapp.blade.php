            ...
            <div class="profile-wrap">
                ...
                <div class="profile-content clearfix">
                    ...
                    <div class="profile-sidebar">
                        ...
                        <div class="profile-section">
                            @if(get_buzzy_config('p_buzzynews') == 'on')<div class="profile-stat">    <div class="profile-stat-label">   <i class="fa fa-file-text"></i>   <span class="stat-text">{{ trans('index.total', ['type' => trans('index.news') ]) }}</span>    </div>  <span class="profile-stat-count">{{ $newscount }} </span>     </div>@endif
                            @if(get_buzzy_config('p_buzzylists') == 'on')<div class="profile-stat">    <div class="profile-stat-label">   <i class="fa fa-th-list"></i>   <span class="stat-text">{{ trans('index.total', ['type' => trans('index.lists') ]) }}</span>    </div>   <span class="profile-stat-count">{{ $listscount }} </span>      </div>@endif
                            @if(get_buzzy_config('p_buzzyquizzes') == 'on')<div class="profile-stat">    <div class="profile-stat-label">   <i class="fa fa-question-circle"></i>   <span class="stat-text">{{ trans('index.total', ['type' => trans('buzzyquiz.quizzes') ]) }}</span>  </div>    <span class="profile-stat-count">{{ $quizzescount }} </span>  </div>@endif
                            @if(get_buzzy_config('p_buzzypolls') == 'on')<div class="profile-stat">    <div class="profile-stat-label">   <i class="fa fa-check-circle-o"></i>   <span class="stat-text">{{ trans('index.total', ['type' => trans('index.polls') ]) }}</span>    </div>  <span class="profile-stat-count">{{ $pollscount }} </span>  </div>@endif
                            @if(get_buzzy_config('p_buzzyvideos') == 'on')<div class="profile-stat">    <div class="profile-stat-label">   <i class="fa fa-youtube-play"></i>   <span class="stat-text">{{ trans('index.total', ['type' => trans('index.videos') ]) }}</span>    </div>  <span class="profile-stat-count">{{ $videoscount }} </span>   </div>@endif
                        </div>
                        @if($userinfo->about )
                        <div class="profile-section">
