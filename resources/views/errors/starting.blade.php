...
@section('content')
    <div class="buzz-container">
        <div class="global-container container starting" style="text-align:center">
            @if(isset($type))
                    ...
                    <p>
                        ...
                        <div class="modeadmin_header" style="margin-top:20px">
                            <div class="modeadmin_text">
                                <p>Warning: You must change admin password on user settings when you are login.</p>
                            </div>
                        </div>
            ...
            <div class="copyright">
                ...
                <b><a href="http://buzzy.akbilisim.com" target="_blank">Buzzy</a></b> Version : {{ config('buzzy.version') }}
            </div>
@endif
