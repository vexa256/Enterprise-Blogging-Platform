...
<head>
  ...
  <title>AlexNews | Documentation</title>
  ...
  <link rel="stylesheet" href="{{ asset('assets/admin/docs/style.css') }}">
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="/admin" class="logo">
      ...
      <span class="logo-lg"><b>AlexNews</b>Admin</span>
    </a>
  ...
  <aside class="main-sidebar">
    <div class="sidebar" id="scrollspy">
      ...
      <ul class="nav sidebar-menu">
        ...
        <li><a href="#AlexNewseditor"><i class="fa fa-circle-o"></i> AlexNewsEditor</a></li>
        <li><a href="#users"><i class="fa fa-circle-o"></i> User Management</a></li>
        <li><a href="#pages"><i class="fa fa-circle-o"></i> Pages</a></li>
        <li><a href="#ads"><i class="fa fa-circle-o"></i> Ads</a></li>
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <h1>
        AlexNews Documentation
        <small>Current version {{ config('AlexNews.version') }}</small>
      </h1>
      <ol class="breadcrumb">
    ...
    <div class="content body">
      ...
      <section id="installation">
        ...
        Checking to ensure that your web host have the minimum requirements to run AlexNews.
        </p>
        <ol>
          <li>PHP &gt;= 5.6.4</li>
        ...
        <hr>
        <h4>Please download "check.php" file and check your web host minimum requirements to run AlexNews with below button.</h4>
        <a class="btn btn-primary" href="">Download Check.php file!</a>
        <hr>
        <p class="lead">
        <H3>Installing AlexNews</H3>
        The following quick steps show how the installation progress. <br><br>
        </p>
        <h4>Step 1 - Unzip and Upload</h4>
        <p> Extract and copy the files from the archive you have downloaded from CodeCanyon to your server.  Make sure you have all files</a> on your server when you have done with upload</p>
        <br>
        ...
        <blockquote>
          <ol>
            <li><a target="_blank" href="/docsassets/ss/sswizard1.png">First step</a> checking requirements <br>
              All requirements must be green. If you have red with one of them. Please check <a target="_blank" href="/docsassets/ss/sscpanelphp2.png">that page</a> on your cpanel (You can find that options on <a target="_blank" href="/docsassets/ss/sscpanelphp1.png" >Select Php Version</a> ). If you did not find any configuration about that. Please contact with your provider.
              <br> <br>
            </li>
            <li><a target="_blank" href="/docsassets/ss/sswizard2.png">Next step</a>, Checking your AlexNews Access. Please click "GET AlexNews Code" button and add your envato purchase code and domain name and take the AlexNews access code and check your AlexNews access code on that page.
              <br>
              <br>
            </li>
            <li><a target="_blank" href="/docsassets/ss/sswizard3.png">On this step</a>, Our installer will check of permissions of directories. If any listed folder is not writable. Please make writable and go to next
              <br>
              <br></li>
            <li><a target="_blank" href="/docsassets/ss/sswizard4.png">Final step</a>, you need to type your database details for creating database. <br>
              <br>
              <code>
      ...
      <section id="configuration">
        ...
        <p class="lead">
          When your installation is complete, it’s time to configure AlexNews.
          <br><br>
      ...
      <section id="login">
        ...
        <ul>
          ...
          <li>When you have done with all steps you can get access token and secret. Type those to AlexNews Admin Panel > Settings > General settings > Login Configuration Facebook app </li>
        </ul>
        <p>

          AlexNews Facebook App Callback Url: <code>http://your-site-name.com/auth/social/facebook/callback</code>
        </p>
        ...
        <ul>
          ...
          <li>When you have done with all steps you can get access token and secret.  Type those to AlexNews Admin Panel > Settings > General settings > Login Configuration Twitter app</li>
        </ul>

        <p>
          AlexNews Twitter App Callback Url: <code>http://your-site-name.com/auth/social/twitter/callback</code>
        </p>

        <div class="callout callout-info lead">
          <h4>Reminder!</h4>
          <p>
            If you get error <code>We cant get your email address! Please register with your email address.</code> on your AlexNews Twitter logining.<br>
        ...
        <ul>
          ...
          <li>When you have done with all steps you can get Client ID and Client secret.  Type those to AlexNews Admin Panel > Settings > General settings > Login Configuration Google app</li>
        </ul>
        <a href="/docsassets/ss/googleappinfo.png" target="_blank">See Full Google App Settings.</A>
        <p>
          AlexNews Google App Callback Url: <code>http://your-site-name.com/auth/social/google/callback</code>
        </p>
      ...
      <section id="posts">
        ...
        <p class="lead">
          AlexNews comes with 4 post types. News, Lists, Polls and Videos. <br>
      ...
      <section id="AlexNewseditor">
        <h2 class="page-header"><a href="#posts">AlexNewsEditor</a></h2>
        <p class="lead">
          AlexNews comes with powerful user post editor. <br>
          With AlexNewsEditor users can add their news, lists, polls and videos.
      ...
      <section id="users">
        ...
        <p class="lead">
          AlexNews owners have full control to users, user information.
        ...
        <ul>
          <li> Username – Usernames must be unique. You can change user username by typing in a new one into the username field and following the instructions that appear.User usernames will display next to any posts user make in the AlexNews Script.<br></li>
      ...
      <!-- ============================================================= -->
      <section id="ads">
        <h2 class="page-header"><a href="#ads">Ads</a></h2>
        <p class="lead">

          You can access your ads from the Admin > Ads.

        <h3>Adding Ads</h3>
        To create ads, In the right ad form show all of the available widgets areas that you can add.
        <br><br>
        <ul>
          <li> Ad Name – As expected, the name of your Ad.<br></li>
          <li> Content – This is where you can put your custom html ad contents.</li>
          <li> Location – This is show all of the available ad  areas that you can add. Select the ad location in here.. </li>
          <li> Display – Ads can be configured to visibility. </li>
        </ul>
        <h3>Removing Ads</h3>
        If you would like to remove a ad, click the Delete link in the configuration options in the list of ads.
      ...
      <section id="languages">
        ...
        <h4> Using exiting langauge support of AlexNews</h4>
        AlexNews has En, Tr, Ru, It, Es support out of box. Just You can use with one quick step
        <ul>
          <li>Open Config Folder > app.php and find  'locale' => 'en' line and type what you have want.</li>
        </ul>
        <h4> Create your langauge support</h4>
        <p class="lead">
          Do you want to use your AlexNews in your Languages? With few quick steps you can set up your site with your language.<br>
          You can translate the AlexNews into your native language following steps.<br>
        ...
        <ul>
          ...
          <li>If you finish translate all available files. You can define your language to AlexNews.</li>
        ...
        <ul>
          ...
          <li>See there is <a target="_blank" href="/docsassets/ss/ssapplang1.png">language settings</a>.</li>
          <li>You can manage language on there. If you want use only specific languages please make sure you have only you want <a target="_blank" href="/docsassets/ss/ssapplang2.png">like this</a></li>
          <li> If you don't want footer multilingual support then remove <a target="_blank" href="/docsassets/ss/ssapplang3.png">all language strings on there</a> <br> You will only get default  one(what you select on 'locale' => 'en', ) if you leave empty this.</li>
          <li> Finally
      ...
      <section id="mail">
        ...
        Please open your cpanel and find <a target="_blank" href="/docsassets/ss/sscpanelemail1.png">Email accounts</a> option on there<br>
        And  <a target="_blank" href="/docsassets/ss/sscpanelemail2.png">create</a> your email address <br>
        Now you have  <a target="_blank" href="/docsassets/ss/sscpanelemail3.png">mail address</a>. Please click more button and click Configure Email Settings option.<br>
        In this page you will get  <a target="_blank" href="/docsassets/ss/sscpanelemail4.png">this information</a>. Get your mail server info and port there too.<br>

        That's it. Please open your env file on your AlexNews main directory. (Please check "I did not find my .env file!" on FAQ tab if you didn't find your env file)
        <br><br>
        Here's the final results must be like this<br>
        <code>MAIL_DRIVER=smtp<br>
          MAIL_HOST=mail.AlexNews.com<br>
          MAIL_PORT=25<br>
          MAIL_USERNAME=info@AlexNews.com<br>
      ...
      <section id="AWSS3">
        ...
        <p class="lead">
          With AlexNews 1.3.1 update allows us to upload posts images and member avatars/splash images to Amazon CDN Storage.<br>
          This is useful for more free space on your server / host.<br>

        <h3>AWS S3 setup</h3>
        You can find set your aws s3 keys in admin panel > settings > file storage settings page<br>

        Here is the default variables We needs to set for AWS S3 support.<br>
     
        <ul>
          <li> FILESYSTEM_DRIVER – It takes "s3" or "local". We need to set this as "s3". If you set this local. Images will upload to your server as default<br></li>
          <li> AWS_ACCESS_KEY_ID – AWS key</li>
          <li> AWS_SECRET_ACCESS_KEY  – AWS secret</li>
          <li> AWS_DEFAULT_REGION – Your Bucket Region. Regions can be: us-east-1,us-west-1,us-west-2,eu-west-1,ap-southeast-1,ap-southeast-2,ap-northeast-1,sa-east-1,us-gov-west-1</li>
          <li> AWS_BUCKET – Your Bucket Name.</li>
        </ul>
      ...
      <section id="easyComment">
        ...
        <h3>
          AlexNews with easyComment</h3>
        AlexNews comes with Facebook Comments and Disqus Comments but also support our comments script called name <a target="_blank" href="http://codecanyon.net/item/easycomment-php-comment-script/12727003">easyComment</a><br><br>

        With easyComment plugin allows you and all AlexNews users can write comments for the posts with their AlexNews accounts.<br>
        easyComment latest update gives us fully entegre comment system. <br>
        All AlexNews users can comment without second registration when you use easyComment.<br>
        ...
        <ul>
          ...
          <li> For installing easyComment, follow the instructions on the easyComment documentaion  <a href="http://easycomment.AlexNews.com/doc.html" target="_blank">here.</a>
          ...
          <li> <code>We suggest you to install on subdomain like comments.yoursite.com. Upload your files to comments subdomain and point your browser to http://comments.yoursite.com/app/install.php.<br>
              ...
              Add your AlexNews domain as yoursite.com and www.yoursite.com. Add both to per line</code>
          </li>

          <li> When you done with easyComment side. There's not much to do.</li>
          <li>Just open your AlexNews Panel and enter the location where you install easyComment to initiation url field on the AlexNews admin panel > plugins > easyComment Plugin Settings. In our example initiation url must be this http://comments.yoursite.com/ </li>
          <li>That's it. Your easyComment works on AlexNews script just fine now!</li>
        </ul>
      ...
      <section id="FAQ">
        ...
        <p class="lead">If you using file manager and did not see any file named .env. Then Please take a look <a target="_blank" href="/docsassets/ss/sscpanelenv.png">that option</a> on your filemanager login popup. Now you can see   <a target="_blank" href="/docsassets/ss/sscpanelenv2.png">.env file </a>. You can right-click  and edit that file on there for some configurations like mail configuration</p>
        ...
        <p class="lead">Please install AlexNews with fresh files and new database.
        ...
        <p class="lead">It means you do not have PHP 5.5 or newer version. AlexNews needs PHP 5.5 / 5.6 or newer version.<br>
        <h5>Upgrade your Php</h5>
        <ul>
          <li>If you using Cpanel so you can find <a target="_blank" href="/docsassets/ss/sscpanelphp1.png">Select Php Version</a> option on Php config section<br> <small> If you  don't have  that option on Cpanel then you need to contact with your provider. They disabled that option on your access </small></li>
          <li><a target="_blank" href="/docsassets/ss/sscpanelphp3.png">Current PHP version:</a> must be 5.5 or 5.6 or 5.7. All good for AlexNews</li>
          <li>And again make sure  your <a target="_blank" href="/docsassets/ss/sscpanelphp2.png">extentions must be like this</a>  </li>
        </ul>
        </p>
        ...
        <ul>
          <li>Please first delete all AlexNews files and upload check.php (You can get check.php file on <a href="#installation">Installation</a> tab). then point your url to www.yoursite.com/check.php and make sure you have all extensions we need. </li>
          <li>Could be missing files.(Here is the full main folders and files you should get from CodeCanyon <a  target="_blank" href="/docsassets/ss/allfiles.png">http://prntscr.com/9caxe3</a>) Make sure you have all.</li>
        ...
        <h5>How to fix it?</h5>
        <ul>
          <li>You need to create your database manually. Please download sql file <a href="http://envato.AlexNews.com/public/export/zip/sqlfile.zip">here</a></li>
          ...
          <li>Than upload installed file to storage folder of AlexNews. That's it your site must be show up.</li>
        </ul>
      ...
      <section id="license">
        ...
        <br>
        <br>
        <a class="btn btn-primary" href="http://codecanyon.net/item/AlexNews-news-viral-lists-polls-and-videos/13300279">Buy Now!</a>
      ...
      <section id="changelog">
        ...
        <h4>V3.0.0<em> – 23/08/19</em></h4>
        <ul>
        <li>Updated to Laravel 5.4 (Requires PHP &gt;=5.6.4)</li>
        <li>Embed &amp; Video system reworked, Now supports more videos sites.</li>
        <li>Upload system reworked. Now deleted, edited posts entries will remove images from server properly.</li>
        <li>S3 system improved. Deleting, editing posts also remove images from S3 bucket.</li>
        <li>S3 configuration now can be changed on admin panel.</li>
        <li>Post-editing will not regenerate all images and entries, only changed and new entries will be saved (In old versions we have created the whole post again and it was caused duplicated upload &amp; entries).</li>
        <li>Post-editing will not regenerate pools, you will not lose votes</li>
        <li>Post editor now allows changing the post slug.</li>
        <li>Post editor now allows changing the post publish date.</li>
        <li>Post editor now shows "Are you sure?" alert when trying to leave the page with the changed post content.</li>
        <li>Now Main categories can accept post types (Story, List, Quiz, Video, Poll). On post create page users can only choice related categories for the post type.</li>
        <li>All main categories can be deleted now. (You can delete News, Lists, Videos, Polls categories now).</li>
        <li>Added: Now you can show/hide categories from the main menu.</li>
        <li>Added: Now you can show/hide category icon on the main menu.</li>
        <li>Added: Now you can order categories on the main menu.</li>
        <li>Added: Now subcategories can have subcategories too.</li>
        <li>Added: Google reCaptcha to log in, register, contact forms. You can turn on/off each.</li>
        <li>Added: New tools section to the admin panel. For now, only has one tool that You can remove saved temporary images from tmp folder to save same space on the host.</li>
        <li>Added: All trash posts section to the admin panel. You can easily see all trashed posts and restore or permanently delete them.</li>
        <li>Fixed: Php 7.2 and above supported now.</li>
        <li>Fixed: Deleted posts not properly remove images from the host.</li>
        <li>Fixed: Themes responsive improved and fixed visual issues.</li>
        <li>Fixed: Lazyload images now work properly. Added new loading effect for images.</li>
        <li>Fixed: Sticky sidebars not working properly.</li>
        <li>Fixed: Visual fixes for post editor.</li>
        <li>Updated all Laravel packages and improved &amp; cleaned the code</li>
        <li>Improved installer &amp; update manager and activation system</li>
        <li>New support center opened on http://support.AlexNews.com. Docs can be found http://support.AlexNews.com/help-center</li>
        </ul>

        <h4>V2.5.1 / V2.5.2<em> – 19/12/17</em></h4>
          - Security fixes<br>
          - Envato api connection fix<br>
        <h4>V2.5 – <em>08/06/17</em></h4>
          - Reaction manager – Now you can add/modify reaction icons http://prntscr.com/fh769f<br>
          - Google Amp support /amp/<br>
          - Two new theme style – http://AlexNewsviralmag.AlexNews.com/ http://AlexNewsboxed.AlexNews.com/<br>
          - Facebook Instant article support – /fbinstant.rss<br>
          - {type}/{post}-{id} post url type option added<br>
          - Google news rss support<br>
          - Arabic language files and RTL support for modern theme<br>
          - Added: 4 new headline posts style http://prntscr.com/fhf96g<br>
          - Added different headline posts style option for category page<br>
          - Autoload posts or “You may also like” option added for post pages<br>
          - Improved reaction voting system<br>
          - Showed reaction badges on post lists<br>
          - Fixed: Wrong quiz answer assign issue<br>
          - Fixed: Minor issues<br>
        <h4>v2.0<em> - 07/11/16</em></h4>
        - Added: Theme System<br>
        - Added  New Modern theme beside the Classic AlexNews theme (More theme will be soon)<br>
        --Modern theme Features<br>
        - More clean Layouts<br>
        - Two type headline for homepage (Headline Slider Type: http://AlexNews.com/assets/AlexNews/modernheadline2.jpg)<br>
        - Improved Page Speed<br>
        - Sticky sidebars<br>
        - Lazy Load for images<br>
        - Improved Scroll Load/Load More options<br>
        - Ads/Widgets can be select for web or mobile on Modern Theme<br>
        - Reaction post lists<br>
        - Much More<br>
        - Added: New Category System. You can add subcategory for subcategory. Example: News > World > Europe <br>
        - Added: "Get content from the URL" button for AlexNewsEditor. You can recreate existed post on site.
        Also you can get data from other sites.(This function currently in beta.)<br>
        - Added: You can select multiple categories.<br>
        - Added: Moved Main language selection to Admin Panel<br>
        - Added: Moved Mail configuration settings to Admin Panel<br>
        - Added: Moved all settings to .env file from the database. Now system will not overload by database connections for setting datas<br>
        - Added: Maintenance Mode option to Admin Panel <br>
        ...
        - Added: "Save as Draft" Option for AlexNewsEditor<br>
        - Added: Facebook Post entry for AlexNewsEditor<br>
        ...
        - Fixed: AlexNewseditor link issue<br>
        - Fixed: Other small issues
        <h4>v1.1.1</h4>
        - This update has minor bug-fixes
        <h4>v1.1</h4>
        - Added: <strong>Tweet</strong> Entry, <strong>Instagram</strong> Entry, <strong>SoundCloud </strong>Entry for AlexNewsEditor<br>
        - Added: Facebook video support for AlexNewsEditor Video Entry<br>
        ...
        <h4>v1.0.5</h4>
        - Added: <strong>"Get image from the url"</strong> support for AlexNewsEditor image entry widget.<br>
        - Added: <strong>"Make preview image"</strong> for  AlexNewsEditor image entry widget.<br>
  ...
  <footer class="main-footer">
    <strong>Copyright &copy; 2020 <a href="">Ayebare Timothy</a>.</strong> All rights reserved.
  </footer>
...
<script src="{{ asset('assets/admin/docs/docs.js') }}"></script>
</body>
</html>
