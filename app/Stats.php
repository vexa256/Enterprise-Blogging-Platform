...
class Stats extends Model
{
    ...
    public function updateStats($date = null)
    {
        ...
        $this->one_day_stats = $this->calculate_days_stats(1, $raw_stats, $date);
        $this->seven_days_stats = $this->calculate_days_stats(7, $raw_stats, $date);
        $this->thirty_days_stats = $this->calculate_days_stats(30, $raw_stats, $date);
     ...
     */
    private function calculate_days_stats($days, $existing_stats, $date)
    {
